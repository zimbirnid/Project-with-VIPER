//
//  WorkerDetailWorkerDetailInteractor.swift
//  cms_mobile
//
...
class WorkerDetailInteractor {
    weak var output: WorkerDetailInteractorOutput!
...
extension WorkerDetailInteractor: WorkerDetailInteractorInput {
    func change(id: Int, data: Data) {
        let request =
            userDefaultsService.isCityBishkek()
            ? BishkekTeacherController.updateTeacher(id: "\(id)", body: data).createURLRequest()
            : OshTeacherController.updateTeacher(id: "\(id)", body: data).createURLRequest()
